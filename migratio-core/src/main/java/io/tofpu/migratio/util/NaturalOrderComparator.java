...
// original version: https://github.com/paour/natorder
public class NaturalOrderComparator implements Comparator<String>, Serializable {
    public static final NaturalOrderComparator INSTANCE = new NaturalOrderComparator();

    public static int compareTo(String a1, String a2) {
        return INSTANCE.compare(a1, a2);
    }

    private static final long serialVersionUID = 3872866887329296504L;
    ...
    int compareRight(String a, String b) {
        ...
        for (; ; ia++, ib++) {
            ...
            if (isNotDigit(ca) && isNotDigit(cb)) {
                return bias;
            }
            if (isNotDigit(ca)) {
                return -1;
